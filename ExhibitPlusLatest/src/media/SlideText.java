...
public class SlideText {
  ...
  public SlideText(Node node, int slideNumber, int sceneWidth, int sceneHeight) {
    ...
    if(ExhibitPlus.style == "nightmode") {
    ...
    if(!fontName.equals(ExhibitPlus.getChosenFont()) && fontSize != ExhibitPlus.getChosenTextSize() &&
    					ExhibitPlus.getChosenFont() != null && ExhibitPlus.getChosenTextSize() != -1) { //
    	basic = Font.font(ExhibitPlus.getChosenFont(), ExhibitPlus.getChosenTextSize());
        italic = Font.font(ExhibitPlus.getChosenFont(), FontPosture.ITALIC, ExhibitPlus.getChosenTextSize());
        bold = Font.font(ExhibitPlus.getChosenFont(), FontWeight.BOLD, ExhibitPlus.getChosenTextSize());

    }else if(!fontName.equals(ExhibitPlus.getChosenFont()) && ExhibitPlus.getChosenFont() != null) {
    	basic = Font.font(ExhibitPlus.getChosenFont(), fontSize);
        italic = Font.font(ExhibitPlus.getChosenFont(), FontPosture.ITALIC, fontSize);
        bold = Font.font(ExhibitPlus.getChosenFont(), FontWeight.BOLD, fontSize);
        
    }else if(fontSize != ExhibitPlus.getChosenTextSize() && ExhibitPlus.getChosenTextSize() != -1) {
    	basic = Font.font(fontName, ExhibitPlus.getChosenTextSize());
        italic = Font.font(fontName, FontPosture.ITALIC, ExhibitPlus.getChosenTextSize());
        bold = Font.font(fontName, FontWeight.BOLD, ExhibitPlus.getChosenTextSize());
	}
    //END OF EDITS
