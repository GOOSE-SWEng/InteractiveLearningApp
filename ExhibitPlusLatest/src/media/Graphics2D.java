...
public class Graphics2D {
	...
	public Graphics2D(ArrayList<Shape> shapes, StackPane sp) {
		this.paneHeight = ExhibitPlus.getStageHeight();
		this.paneWidth = ExhibitPlus.getStageWidth();
		// clones arrayList
		this.shapes = shapes; 
	...
	public float scaleX(float p) {
		return((p*ExhibitPlus.getStageWidth())/100);
	}
	public float scaleY(float p) {
		return((p*ExhibitPlus.getStageHeight())/100);
	}
